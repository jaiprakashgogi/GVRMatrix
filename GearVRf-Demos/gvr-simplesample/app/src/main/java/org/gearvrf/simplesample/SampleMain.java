...
public class SampleMain extends GVRScript {
    ...
    public void onInit(GVRContext gvrContext) {
      ...
      //  scene.addSceneObject(sceneObject);
        ...
        GVRTexSceneObject texSceneObject = new GVRTexSceneObject(gvrContext, 4.f, 2.f);
        texSceneObject.getTransform().setPosition(0.f, 0.f, -3.f);
        scene.addSceneObject(texSceneObject);
